...
ollama pull qwen3.5:35b # 23G,一张4060显卡+32G内存可运行,效果最好
ollama pull glm-4.7-flash # 19G,一张4060显卡+32G内存可运行,效果最好
ollama pull qwen3-coder:latest # 18G,一张4060显卡+32G内存可运行,不输出思考过程

ollama pull qwen3.5:9b # 6.6G,一张4060即可流畅运行
ollama pull qwen3:8b # 5G,一张4060即可流畅运行

ollama pull qwen3.5:4b # 3.4G,CPU可运行
ollama pull qwen3:4b # 2.5G,CPU可运行
ollama pull qwen3:4b-instruct # 2.5G,CPU可运行,不输出思考过程

# 建议模型的参数不要小于4b,上下文不小于8K,如下载时遇到卡顿,可以按ctrl+c停止再继续下载
```
